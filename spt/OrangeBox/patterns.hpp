...
namespace Patterns
{
	...
	const MemUtils::ptnvec ptnsCmd_ExecuteCommand =
	{
		{
			"5135",
			{
				0x55, 0x8B, 0x6C, 0x24, 0x08, 0x8B, 0x45, 0x00, 0x85, 0xC0, 0x75, 0x02, 0x5D, 0xC3, 0x85, 0xC0, 0x56, 0xBE, '?', '?', '?', '?', 0x7E, 0x06, 0x8B, 0xB5, 0x08, 0x04, 0x00, 0x00, 0x57, 0xBF, '?', '?', '?', '?', 0xB9, 0x08, 0x00, 0x00, 0x00, 0x33, 0xD2
			},
			"xxxxxxxxxxxxxxxxxx????xxxxxxxxxx????xxxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsCbuf_AddText =
	{
		{
			"5135",
			{
				0xFF, '?', '?', '?', '?', '?', 0x8B, 0xC8, 0xA1, '?', '?', '?', '?', 0x3B, 0xC8, 0x74, 0x13, 0x56, 0x8B, 0xD1, 0xBE, '?', '?', '?', '?', 0x33, 0xC0, 0xF0, 0x0F, 0xB1, 0x16, 0x85, 0xC0, 0x5E, 0x75, 0x09, 0x83, '?', '?', '?', '?', '?', '?', 0xEB, 0x10, 0xF3, 0x90, 0x6A, 0x00, 0x51, 0xB9, '?', '?', '?', '?', 0xFF, '?', '?', '?', '?', '?', 0x8B, 0x44, 0x24, 0x04, 0x6A, 0x00
			},
			"x?????xxx????xxxxxxxx????xxxxxxxxxxxx??????xxxxxxxx????x?????xxxxxx"
		}
	};

	const MemUtils::ptnvec ptnsHandleEngineKey =
	{
		{
			"5135",
			{
				0x8B, 0x44, 0x24, 0x04, 0x81, 0xEC, 0x00, 0x04, 0x00, 0x00, 0x83, 0x38, 0x01, 0x53, 0x56, 0x8B, 0x70, 0x08, 0x0F, 0x95, 0xC3, 0x84, 0xDB, 0x57
			},
	...
	const MemUtils::ptnvec ptnsCGameMovement__FullWalkMove =
	{
		{
			"5135",
			{
				0x83, 0xEC, 0x08, 0x56, 0x8B, 0xF1, 0x8B, 0x06, 0x8B, 0x90, 0x98, 0x00, 0x00, 0x00, 0xFF, 0xD2, 0xD9, 0xEE, 0x8B, 0x46, 0x08, 0xD9, 0x50, 0x68, 0x83, 0xC0, 0x68, 0xD9, 0x50, 0x04, 0xD9, 0x50, 0x08, 0x8B, 0x46, 0x08, 0xD9, 0x50, 0x74, 0x83, 0xC0, 0x74
			},
